...
- **[Android]**: Fixes an issue with `getDeliveredNotifications` where the id returned is not the original id when displaying the notification. (Fixes [#381](https://github.com/notifee/react-native-notifee/issues/381))
